...
class main extends DBImportTemplate {
    ...
    private zOrderAnimation(_zOrder,data)
    {
    ...
    private getZOrderBySlotName(slotName)
    {
    ...
    private fddFrameAnimation(fddFrame, data,weightMeshObj) {
    ...
    private transFfdFrameWeigthMesh(ffdFrame,frame,ffdWeightList){
    ...
    private getVerticesMoreBone(ffdWeight,ffdWeightList){
        var point = new Point();
        var p = new Point();
    ...
    private getNextEdges(p0, p1, allEdges, points, lastAngle) {
    ...
    private getAngle(p0:Point, p1:Point) {
        var a = p1.x - p0.x;
        var b = p1.y - p0.y;
    ...
    private createBoneList(_boneList)
    {
        this.boneList = [];
        var i = 0
    ...
    private setBoneParent(bone,parent)
    {
        var obj = {};
    ...
    private boneMatrix = [];
    private createMatrix(transform)
    {
    ...
    public transformToMatrix(transform, matrix)
    {
    ...
    private createWeightedMeshData(displayObj,verticesList)
    {
        var dbVertices = [];
