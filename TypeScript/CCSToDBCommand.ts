...
class CCSToDBCommand implements egret.Command {
    private bones = {};
    private resultArr = [];
    private layersInfo = {};
    private dbTexture = {};
    ...
    initOptions(options:Object):void {
        this.outputPath = <string>(params.getObjectOption(options, '--output'));
    ...
    private parseTexture(stuTexture, ccTexture) {
